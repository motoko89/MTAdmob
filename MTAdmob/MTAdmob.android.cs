...
namespace MarcTron.Plugin
{
    ...
    public class MTAdmobImplementation : InterstitialAdLoadCallback, IMTAdmob
    {
        ...
        public virtual void MOnRewardOpened() => OnRewardedVideoAdOpened?.Invoke(this, EventArgs.Empty);
        public virtual void MOnRewardClosed() => OnRewardedVideoAdClosed?.Invoke(this, EventArgs.Empty);
        ...
        public virtual void MOnUserEarnedReward(IRewardItem p0) => OnRewarded?.Invoke(this, new MTEventArgs() { RewardType=p0.Type, RewardAmount=p0.Amount });
